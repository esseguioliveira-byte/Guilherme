...
export default function LoginForm() {
  ...
  const handleSocialLogin = async (provider: string) => {
    ...
    try {
      ...
      // O redirecionamento deve acontecer antes de chegar aqui se for bem sucedido
      // mas mantemos o estado por segurança
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          ...
          disabled={!!socialLoading || isPending}
          className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-[#111] border border-[#222] hover:bg-[#1a1a1a] hover:border-[#333] text-gray-300 transition-all group disabled:opacity-50"
        >
