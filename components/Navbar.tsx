    ...
    <nav className="fixed top-0 w-full z-50 bg-[#02040a]/40 backdrop-blur-xl border-b border-white/5">
      <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 group shrink-0">
          ...
          <span 
            className="text-lg font-black tracking-[0.15em] bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent uppercase hidden sm:block"
        ...
        <div className="flex items-center gap-6">
          ...
          {session?.user ? (
            ...
            <Link href="/login" className="flex items-center gap-2 px-5 py-2 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-primary/50 rounded-full transition-all text-xs font-black uppercase tracking-widest text-white italic">
