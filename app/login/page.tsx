    ...
    <div className="min-h-screen flex items-center justify-center bg-black p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-[#0A0A0A] border border-[#222] rounded-2xl p-8 shadow-[0_0_40px_rgba(59,130,246,0.1)] relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-white italic uppercase tracking-tighter">Acessar Conta</h1>
          <p className="text-sm text-gray-400 mt-2 font-medium">Bem-vindo de volta à <span className="text-primary font-bold">Bahia Store</span></p>
        </div>
