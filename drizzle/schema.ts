import { mysqlTable, mysqlSchema, AnyMySqlColumn, foreignKey, varchar, text, int, index, decimal, mysqlEnum, timestamp, unique, longtext, tinyint } from "drizzle-orm/mysql-core"
